...
group.add_argument(
    '--flip_p', type=float, default=0.5, help='prob of flipping'
)
group.add_argument(
    '--load_step', type=int, default=1, help='Store the gap steps of van in the forward process'
)
...
group.add_argument('--L1', type=int, default=30, help='number of sites on each edge of the lattice')
